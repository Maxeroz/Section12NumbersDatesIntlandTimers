...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    // When 0 seconds, stop timer and lot out user
    if (time === 0) {
      clearInterval(timer);
...
console.log(new Date('Aug 23 2023 19:51:17'));
...
const days1 = calcDaysPassed(new Date(2037, 3, 10), new Date(2037, 3, 5));
